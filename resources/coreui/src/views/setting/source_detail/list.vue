      ...
      <div class="col-lg-12">
        <div class="card">
          ...
          <div class="card-header">
            <strong>Danh sách nguồn chi tiết</strong>
          </div>
          <div class="card-body">
            <div class="row">
              ...
              <div class="form-group col-sm-12">
                <router-link class="btn btn-success" :to="'/setting/source_detail/add'">
                ...
                <tr v-for="(item, index) in users" :key="index">
                  ...
                  <td>
                    <router-link
                      ...
                      :to="`/setting/source_detail/${item.id}/edit`"
...
export default {
  ...
  methods: {
    ...
    search(a) {
      ...
      const link = "/api/source_detail/list";
