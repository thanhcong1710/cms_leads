                  ...
                  <div class="row no-margin">
                    ...
                    <div class="form-group col-sm-6">
                      ...
                      <select class="form-control" v-model="parent.status" disabled>
                        <option value="0" v-if="parent.status<70">0. KH mới</option>
                        <option value="10" v-if="parent.status<70">1. KH không liên lạc được</option>
                        <option value="20" v-if="parent.status<70">2. KH ở vùng CMS không có cơ sở</option>
                        <option value="30" v-if="parent.status<70">3. KH không nghe máy</option>
                        <option value="40" v-if="parent.status<70">4. KH hẹn gọi lại sau</option>
                        <option value="50" v-if="parent.status<70">5. KH không quan tâm</option>
                        <option value="60" v-if="parent.status<70">6. KH không tiềm năng</option>
