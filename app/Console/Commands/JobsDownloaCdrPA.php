...
class JobsDownloadCdrPA extends Command
{
    ...
    {
        $file_name='out-0389941902-1410-20241106-142308-1730877784.25070.wav';
        $dir = __DIR__.'/../../../public/static/voip/'. date('Y_m').'/';
        $url = "https://crm.pavietnam.vn/cloud-phone/play-audio?file=symlink/monitor/".date('Y/m/d')."/".$file_name;   // Replace with your file URL
