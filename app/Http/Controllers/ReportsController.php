...
class ReportsController extends Controller
{
    ...
    public function report05(Request $request)
    {
        ...
        $total = u::first("SELECT COUNT(*) AS total FROM (SELECT p.pre_owner_id, p.owner_id FROM cms_parent_assign AS p  
            WHERE $cond GROUP BY p.pre_owner_id,p.owner_id) AS t");
