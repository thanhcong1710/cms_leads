...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0___default.a.get("api/students/detail/".concat(this.$route.params.id, "?token=") + localStorage.getItem("api_token")).then(function (response) {
  ...
  methods: {
    ...
    save: function save() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post("/api/students/update/".concat(this.$route.params.id, "?token=") + localStorage.getItem("api_token"), this.student).then(function (response) {
        _this2.loading.processing = false;

        if (response.status == 200) {
          _this2.modal.color = "success";
          _this2.modal.body = "Cập nhật học sinh thành công";
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "card-header" }, [
      _c("strong", [_vm._v("Cập nhật học sinh")])
    ])
  },
  function() {
    var _vm = this
