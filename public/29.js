...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    save: function save() {
      ...
      if (this.student.phone != "" && !_utilities_utility__WEBPACK_IMPORTED_MODULE_1__["default"].vld.phone(this.student.phone)) {
        mess += " - Số điện thoại không đúng định dạng<br/>";
        resp = false;
      }

      if (this.student.email != "" && !_utilities_utility__WEBPACK_IMPORTED_MODULE_1__["default"].vld.email(this.student.email)) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post("/api/students/add?token=" + localStorage.getItem("api_token"), this.student).then(function (response) {
        _this.loading.processing = false;

        if (response.status == 200) {
          _this.modal.color = "success";
          _this.modal.body = "Thêm mới học sinh thành công";
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "card-header" }, [
      _c("strong", [_vm._v("Thêm mới học sinh ")])
    ])
  },
  function() {
    var _vm = this
