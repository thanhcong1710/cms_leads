...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    updateSipID: function updateSipID() {
      var _this = this;
      ...
      _utilities_utility__WEBPACK_IMPORTED_MODULE_1__["default"].p("/api/user/update-sip", data).then(function (response) {
  ...
  return _c(
    ...
    [
      ...
      _c(
        ...
        [_c("strong", [_vm._v(_vm._s(_vm.user_name))])]
      ),
      _vm._v(" "),
      _c("div", { staticClass: "dropdown-item" }, [
        ...
        _c("input", {
          ...
          staticStyle: { width: "80px", "margin-left": "10px" },
          domProps: { value: _vm.user_sip },
          on: {
            input: function($event) {
              if ($event.target.composing) {
                return
              }
              _vm.user_sip = $event.target.value
            }
          }
        }),
        _vm._v(" "),
